 ...
 */
export declare class ZepClientError extends Error {
    responseData?: any;
    /**
 ...
 */
export declare class UnexpectedResponseError extends ZepClientError {
}
/**
 * Custom error class for not found errors in the ZepClient.
 */
export declare class NotFoundError extends ZepClientError {
}
/**
 * Custom error class for authentication errors in the ZepClient.
 */
export declare class AuthenticationError extends ZepClientError {
}
